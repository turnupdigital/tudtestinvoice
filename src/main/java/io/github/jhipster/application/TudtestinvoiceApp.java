...
public class TudtestinvoiceApp {

    private static final Logger log = LoggerFactory.getLogger(TudtestinvoiceApp.class);

    private final Environment env;

    public TudtestinvoiceApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes tudtestinvoice.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TudtestinvoiceApp.class);
